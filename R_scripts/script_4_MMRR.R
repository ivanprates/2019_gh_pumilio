...
## This script performs Multiple Matrix Regression with Randomization (MMRR) analyses based on ant, alkaloid, and geographic distance data.
...
# Import matrices for ant, alkaloid, alkaloid class, and geographic distances
...
# Using geographic distance only
predictor = geo
predictor_list = list(geo = geo)
predictor_name = "geo"

# Using genetic distance only
predictor = gen
